...
export const NavMenu = ({ isHome }: { isHome: boolean }) => {
    ...
    return (
        <>
            {!isHome && (
                <div
                    className="md:hidden fixed w-full top-0 left-0 h-12 z-50 flex flex-row justify-between items-center px-4 tech:bg-tech-gray-50 whimsical:bg-whim-green-200 classic:bg-classic-gray-50 classic:border-b classic:shadow-sm"
                    role="mobile-navigation-banner"
                >
